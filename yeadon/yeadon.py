...
while done != 1:
    ...
    # LOAD JOINT ANGLES
        ...
        print "Be careful with this, because there is no error checking yet."\
              " Make sure that the pickle file is in the same format as a",\
              "pickle output file from this program."
