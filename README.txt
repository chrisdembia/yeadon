...
lines below to install the package, assuming you have python2.7 installed.
...
Again, this assumes that you have installed python2.7. You can build (create) the yeadon documentation if you have the python sphinx package (see above) by typing, in the same yeadon/ directory
...
You can begine the command line interface by executing
